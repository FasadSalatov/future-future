...
const checkChannel = async () => {
  ...
  try {
    ...
    if (response.data.answer === "not sub") {
...
const connectWallet = async () => {
  ...
  try {
    ...
    toast.add({
      title: "Попробуйте подключить еще раз",
    });
  }
};
    ...
    <div class="v-container" v-if="taskStatus">
      <div class="tasks">
        ...
        <AirdropTask
          ...
          toolTitle="Будь в курсе последних новостей о проекте Futurum. Следи за обновлениями, зарабатывай с проектом FUTURUM. "
        />
        ...
        <AirdropTask
          ...
          toolTitle="Данные логин и пароль ты сможешь использовать для входа на маркетплейс FUTURUM со дня официального открытия 26 октября."
        />
        ...
        <AirdropTask
          ...
          toolTitle="На данную почту будут приходить уведомления о твоих покупках, продажах, пополнениях баланса и прочая важная информация в процессе работы с маркетплейсом FUTURUM."
        />
        ...
        <AirdropTask
          ...
          iconSrc="/icon/verift-icon.svg"
          toolTitle="Расскажи немного о себе и своих ожиданиях о проекте."
          modalSrc="/image/airdrop/Frame10.png"
        />
      </div>
    </div>
    ...
    <div class="v-container">
      <div class="tasks">
        <AirdropTask
          ...
          :title="
            refferals?.length == 0 ? 'Пригласи друга' : 'Пригласи следующего'
          "
          iconSrc="/icon/friend-icon.png"
          toolTitle="Приглашайте друзей, чтобы вместе зарабатывать токены Х100"
        />
        ...
        <AirdropTask
          ...
          toolTitle="Ваше первое задание, которое защищает нас с вами, от атак ботов"
        />
        ...
        <AirdropTask
          ...
          toolTitle="Подключите свой кошелек, на который в последствии будут отправлены токены AirDropa X100"
        />
      </div>
    </div>
  </div>
